...
mbr.bin: mbr.s mbr.ls
	$(ASM) $(CFLAGS) -c mbr.s -o mbr.o
	ld -Tmbr.ls -o mbr.bin mbr.o

stage2.bin: stage2.ls $(SRCFILE)
	$(ASM) $(CFLAGS) -m32 -c stage2.s -o stage2.o
	$(ASM) $(CFLAGS) -m32 -c asm_func.s -o asm_func.o
	$(ASM) $(CFLAGS) -m32 -c ./interrupt_handler/handler20.s -o handler20.o
	$(ASM) $(CFLAGS) -m32 -c ./interrupt_handler/handler21.s -o handler21.o
	$(ASM) $(CFLAGS) -m32 -c ./interrupt_handler/handler26.s -o handler26.o
